...
const AnimatedBackground = () => {
  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <motion.div
        className="absolute bottom-0 left-0 w-full h-32 bg-gradient-to-t from-rose-100/20 to-transparent"
        animate={{
          opacity: [0.3, 0.6, 0.3],
        }}
        transition={{
      ...
      {/* Soft light rays */}
      <motion.div
        className="absolute top-0 right-0 w-64 h-64 bg-gradient-radial from-rose-200/10 to-transparent rounded-full"
        animate={{
          scale: [1, 1.2, 1],
          opacity: [0.3, 0.5, 0.3],
        }}
      ...
      <motion.div
        className="absolute top-1/4 left-0 w-48 h-48 bg-gradient-radial from-pink-200/10 to-transparent rounded-full"
        animate={{
          scale: [1, 1.3, 1],
          opacity: [0.2, 0.4, 0.2],
        }}
